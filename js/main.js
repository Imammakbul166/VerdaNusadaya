...
const products = [
    {
        ...
        category: "kopi",
        description: "Kopi arabika pilihan dengan cita rasa yang khas dan aroma yang menggugah selera.",
    ...
    },
    {
        ...
        name: "Karet SIR-20",
        category: "karet",
        description: "Karet berkualitas tinggi sesuai standar internasional untuk industri.",
        image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        price: "Rp 25.000/kg",
        rating: 4.7,
        isFeatured: true,
        specs: ["SIR-20 Standard", "Moisture < 0.8%", "Impurities < 0.05%", "Packing 50kg"]
    },
    {
        id: 3,
        ...
        image: "https://images.unsplash.com/photo-1592982537442-025781f5f7eb?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        price: "Rp 12.000/kg",
        rating: 4.9,
        isFeatured: true,
        specs: ["FFB Quality", "Free Fatty Acid < 5%", "Moisture < 0.2%", "Halal Certified"]
    },
    {
        id: 4,
        name: "Kopi Robusta",
    ...
    },
    {
        ...
        rating: 4.5,
        isFeatured: false,
        specs: ["RSS-1 Standard", "Moisture < 0.8%", "Impurities < 0.05%", "Packing 50kg"]
    },
    {
        id: 6,
        name: "Minyak Goreng Sawit",
        category: "kelapa-sawit",
        description: "Minyak goreng berkualitas tinggi untuk kebutuhan rumah tangga dan industri.",
        image: "https://images.unsplash.com/photo-1592982537442-025781f5f7eb?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    ...
    },
    {
        ...
        category: "karet",
        description: "Karet dengan spesifikasi teknis khusus untuk industri otomotif.",
        image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        price: "Rp 28.000/kg",
        rating: 4.4,
        isFeatured: false,
    ...
    },
    {
        ...
        rating: 4.7,
        isFeatured: false,
        specs: ["Arabica-Robusta Blend", "Medium Roast", "Balanced Flavor", "Daily Drinking"]
    },
    {
        id: 11,
        name: "Karet Latex",
        category: "karet",
        description: "Lateks karet alam berkualitas tinggi untuk industri gloves dan lainnya.",
        image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        price: "Rp 20.000/kg",
        rating: 4.5,
        isFeatured: false,
        specs: ["High Ammonia", "Dry Rubber Content 60%", "Fresh Latex", "Food Grade"]
    },
    {
        id: 12,
...
function createProductCard(product) {
    ...
    card.className = 'card group hover:shadow-xl transition-all duration-300 overflow-hidden';
...
function handleContactForm(e) {
    ...
    setTimeout(() => {
        ...
        formStatus.className = 'p-4 bg-green-50 border border-green-200 rounded-md mb-4';
